...
namespace PivotalTFSSync.TFS
{
    public class TFS : ITFS
    {
        ...
        void ITFS.AddPivotalStoryToTFS(Story pivotalStoryToAdd, string projectname, string iterationPath, string subPath)
        {
            ...
            workItem.Fields[TFSConstants.ConchangoTeamsystemScrumEstimatedeffort].Value = pivotalStoryToAdd.Estimate;
            workItem.Fields[TFSConstants.ConchangoTeamsystemScrumBusinesspriority].Value = pivotalStoryToAdd.Priority;
            workItem.Fields[TFSConstants.ConchangoTeamsystemScrumDeliveryorder].Value = pivotalStoryToAdd.Priority;
        ...
        {
            foreach (Field field in from WorkItem item in workitems from Field field in item.Fields select field)
            {
